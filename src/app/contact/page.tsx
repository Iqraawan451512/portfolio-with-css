import "./contact.css"
import Header_two from "@/component/header/header-1"
...
<li className="cont-li">phone: <a href="" className="cont-a"> 03341347769</a></li>
<li className="cont-li">Email: <a href="" className="cont-a"> iqraawan451512@gmail.com</a></li>
<li className="cont-li">Github: <a href="" className="cont-a"> iqraawan451512@gmail.com</a></li>
<li className="cont-li">LinkedIn: <a href="" className="cont-a"> iqraawan451512@gmail.com</a></li>
