...
<div className="pro-one">
  ...
  <p className="pro-para"> <a href=""> E commerce website </a> </p>
          ...
          Visit my <Link href="https://github.com/Iqraawan451512" target="_blank" className=" para font-bold text-red-300">GitHub</Link>  ,<Link href="https://vercel.com/iqra-awans-projects"target="_blank" className=" para font-bold text-red-300">Versal</Link>, or <Link href="" className=" para font-bold text-red-300">npm</Link> profile for
